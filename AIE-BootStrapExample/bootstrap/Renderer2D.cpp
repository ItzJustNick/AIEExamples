...
namespace aie
{
    Renderer2D::Renderer2D()
    {
        ...
        glBufferData(GL_ELEMENT_ARRAY_BUFFER, (MAX_SPRITES * 6) * sizeof(unsigned short), (void*)(&m_indices[0]),
                     GL_STATIC_DRAW);
    ...
    void Renderer2D::begin()
    {
        ...
        auto projection = glm::ortho(m_cameraX, m_cameraX + (float)width, m_cameraY, m_cameraY + (float)height, 1.0f,
                                     -101.0f);
    ...
    void Renderer2D::drawText(Font* font, const char* text, float xPos, float yPos, float depth)
    {
        ...
        while (*text != 0)
        {
            ...
            stbtt_GetBakedQuad((stbtt_bakedchar*)font->m_glyphData, font->m_textureWidth, font->m_textureHeight,
